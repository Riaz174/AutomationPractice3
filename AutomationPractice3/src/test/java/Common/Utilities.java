...
public class Utilities {
   ...
   public void Browsers(String browsers, String wbsite) {
		  if(browsers.equalsIgnoreCase("Chrome")) {
			  ...
			  System.setProperty("webdriver.edge.driver", "C:\\Users\\riaz_\\git\\repository5\\AutomationPractice3\\src\\Drivers\\msedgedriver.exe");
  ...
  public void shots() throws IOException {
	  ...
	  FileHandler.copy(ks, new File("C:\\Users\\riaz_\\git\\repository5\\AutomationPractice3\\Pictures\\" + sd + "pictureOfWebsite.jpg"));
